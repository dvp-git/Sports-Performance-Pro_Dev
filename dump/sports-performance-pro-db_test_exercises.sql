...
CREATE TABLE `test_exercises` (
  `test_exercise_id` int NOT NULL AUTO_INCREMENT,
  `test_block_id` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `loads` varchar(255) DEFAULT NULL,
  `reps` int DEFAULT NULL,
  `sets` int DEFAULT NULL,
  PRIMARY KEY (`test_exercise_id`),
  KEY `test_block_id` (`test_block_id`),
  CONSTRAINT `test_exercises_ibfk_1` FOREIGN KEY (`test_block_id`) REFERENCES `test_blocks` (`test_block_id`)
