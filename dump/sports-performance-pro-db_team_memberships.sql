...
CREATE TABLE `team_memberships` (
  ...
  KEY `team_id` (`team_id`),
  CONSTRAINT `team_memberships_ibfk_1` FOREIGN KEY (`athlete_id`) REFERENCES `athletes` (`athlete_id`),
  CONSTRAINT `team_memberships_ibfk_2` FOREIGN KEY (`team_id`) REFERENCES `teams` (`team_id`)
...
INSERT INTO `team_memberships` VALUES (1,1,1),(2,2,1);
