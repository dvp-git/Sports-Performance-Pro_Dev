...
const validateForm = function isValidForm(name, email, phone, password) {
  ...
  //     valid = false;
  //     ageEerror.textContent = "Please enter a valid age (numbers only).";
  //   }
...
registerButton.addEventListener("click", function (event) {
  ...
  valid_ = validateForm(nameInput, emailInput, phoneInput, passwordInput);
  if (valid_) {
